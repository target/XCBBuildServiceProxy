...
extension BuildRequest: DecodableRPCPayload {
    public init(args: [MessagePackValue], indexPath: IndexPath) throws {
        ...
        self.enableIndexBuildArena = try args.parseBool(indexPath: indexPath + IndexPath(index: 13))
        self.useLegacyBuildLocations = try args.parseBool(indexPath: indexPath + IndexPath(index: 14))
        self.shouldCollectMetrics = try args.parseBool(indexPath: indexPath + IndexPath(index: 15))
    }
}
