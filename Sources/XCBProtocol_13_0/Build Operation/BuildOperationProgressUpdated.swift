...
extension BuildOperationProgressUpdated: DecodableRPCPayload {
    public init(args: [MessagePackValue], indexPath: IndexPath) throws {
        ...
        self.statusMessage = try args.parseString(indexPath: indexPath + IndexPath(index: 0))
        self.completedTasks = try args.parseString(indexPath: indexPath + IndexPath(index: 1))
