...
extension BuildRequest: DecodableRPCPayload {
    public init(args: [MessagePackValue], indexPath: IndexPath) throws {
        ...
        self.useLegacyBuildLocations = try args.parseBool(indexPath: indexPath + IndexPath(index: 15))
        self.shouldCollectMetrics = try args.parseBool(indexPath: indexPath + IndexPath(index: 16))
    }
}
